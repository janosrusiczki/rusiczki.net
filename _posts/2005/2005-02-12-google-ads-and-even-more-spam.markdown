...
But my referer log is practically unusable after being flooded with viagra, cialis, poker, casinos and the alikes (here's [a sad screenshot](https://content.rusiczki.net/blogpics/referer_log_spam.gif){:.glightbox} of the top referers). It looks like after [the measures](http://www.google.com/googleblog/2005/01/preventing-comment-spam.html) Google and the major weblog software developers took against comment spamming, the spammers are getting back to good ol' referer log spamming. Well, at least my stats are password protected so there's no chance they're getting pagerank from that. Hah!
