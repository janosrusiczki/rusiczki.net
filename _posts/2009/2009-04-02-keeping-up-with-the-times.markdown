...
I also solved the permalink problems by following [the relevant guide](http://codex.wordpress.org/Importing_from_Movable_Type_to_WordPress) from the ever handy [WordPress Codex](http://codex.wordpress.org). I know from [a previous experience](https://www.rusiczki.net/2006/01/06/latest-site-updates/) that it doesn't take Google long to reindex my stuff but I also needed the redirect script for the sake of those who linked to my articles from other sites. Yep, this includes myself. And yes, the geek speaks out, I like the WordPress style permalinks a lot more. 
