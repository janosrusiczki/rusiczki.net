...
A few notes on what happened when I tried to order an SVBONY SV605CC astronomy camera from SVBONY's official European store. Short version: I'm dissapointed, and I figure other buyers might want to know what they could be walking into.
...
*I'll update this post once the situation gets resolved one way or the other. I've contacted SVBONY support and I'm waiting to hear back.*
